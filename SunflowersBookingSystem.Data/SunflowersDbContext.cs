    ...
    public class SunflowersDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Room>()
                ...
                new Room() { Id = 2, Number = 2, Capacity = 2, Booked = true },
            ...
            builder.Entity<Reservation>()
                .HasData(
                new Reservation { Id = 1, StartDate = DateTime.Now, EndDate = DateTime.UtcNow, ArriveTime = DateTime.Today, Comment = "It was aight", UserId = 3, RoomId = 1 },
                new Reservation { Id = 2, StartDate = DateTime.Now, EndDate = DateTime.UtcNow, ArriveTime = DateTime.Today, Comment = "same", UserId = 3, RoomId = 2 });
        }
    }
}
